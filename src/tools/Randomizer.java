...
public class Randomizer 
{
    ...
    public static Athlete generateAthlete() {
        ...
        int     age     = generate(15, 19);
        boolean isMale  = generate();
        int     number  = generate(100, 999);
     ...
     * @param size the size of the list to generate
     */
    public static Athlete[] generateAthletes(int size) {
     ...
     * @param size the size of the array to generate
     */
    public static LinkedList<Athlete> generateAthleteList(int size) {
