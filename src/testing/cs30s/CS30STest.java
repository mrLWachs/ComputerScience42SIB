...
/**
 * CS30STest.java - the large in class example we continue to work 
...
public class CS30STest 
{
     ...
     */
    public CS30STest() {
        System.out.header("Computer Science 30S course started..."); 
        learnBasicJava();        
        learnMethods();  
        learnArrays();
        learnClasses();
        learnGraphics();
        System.out.header("Computer Science 30S course completed!");
    }
    ...
    private static void learnBasicJava() {
        System.out.header("Java basics started...");
        ...
        */
        ...
        System.out.header("Java basics completed!");
    }
    ...
    private static void learnMethods() {
        System.out.header("Methods unit starting...");
        ...
        System.out.header("Methods unit completed!");
    }
    ...
    private static void learnArrays() {
        System.out.header("Arrays unit starting...");
        ...
        System.out.header("Arrays unit complete!");
    }
    ...
    private static void learnClasses() {
        System.out.header("Classes unit started...");
        ...
        System.out.header("Classes unit complete!");
    }
